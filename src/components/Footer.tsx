...
const gamesRow = [
  getBasePath("/images/665990488_4463411690642997_4580202065504028951_n.jpg"),
  getBasePath("/images/690953298_1332313532099290_2726634727127638217_n.jpg"),
  getBasePath("/images/693435817_2038086813725139_1562932010930628367_n.jpg"),
  getBasePath("/images/665990488_4463411690642997_4580202065504028951_n.jpg"),
  getBasePath("/images/690953298_1332313532099290_2726634727127638217_n.jpg"),
  getBasePath("/images/693435817_2038086813725139_1562932010930628367_n.jpg"),
  getBasePath("/images/665990488_4463411690642997_4580202065504028951_n.jpg"),
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              {/* 1. สร้างก้อนข้อมูลที่ผูกพิกัด ID ไว้ */}
              {[
                { label: "หน้าแรก", id: "home" },
                { label: "เกมแนะนำ", id: "recommended" },
                { label: "หมวดหมู่", id: "categories" },
              ].map((item) => (
                <li key={item.id}>
                  <Link
                    href={`#${item.id}`}
                    ...
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.color = "var(--bb-amber)")
                    }
                    onMouseLeave={(e) =>
          ...
          <div>
            ...
            >
              ...
              >
                <Phone size={18} /> 083-727-8422
              </div>
              <div
                style={{ display: "flex", alignItems: "center", gap: "0.8rem" }}
              >
                <Mail size={18} /> blayblayplaywork@gmail.com
              </div>
              <div
                style={{
                  display: "flex",
