...
export default function HeroSection() {
  return (
    ...
    >
      {/* แทรกสไตล์ CSS สำหรับทำเอฟเฟคลอยขึ้นลง (Floating) โดยตรง เพื่อไม่ให้บราวเซอร์ทำหายตอนกดย้อนกลับ */}
      <style>{`
        ...
        .float-item-1 { animation: customFloat1 4s ease-in-out infinite; }
        .float-item-2 { animation: customFloat2 3.5s ease-in-out infinite; }
      `}</style>
      ...
      >
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            ไม่ว่าคุณจะมากับเพื่อน ครอบครัว หรือมาเดท
            เรามีเกมให้เลือกหลากหลายแนว มีคนสอนให้ เล่นสนุก เป็นกันเอง
            เริ่มเล่นได้เลย แม้ไม่เคยเล่นมาก่อน!
          </p>
          ...
          >
            <a
              ...
              style={{
                ...
                border: "none",
                borderRadius: "30px",
                boxShadow: "0 6px 15px rgba(0,87,184,0.3)",
        ...
        >
          ...
          {/* รูปที่ 3: Codenames (รูปตรงกลางเด่นสุด) */}
          <div
            style={{
              position: "absolute",
              zIndex: 4,
