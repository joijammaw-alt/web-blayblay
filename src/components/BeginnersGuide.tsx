...
export default function BeginnersGuide() {
  return (
    ...
    >
      {/* แทรกสไตล์จังหวะ Hover เพิ่มความพรีเมียมให้กับการ์ดขั้นตอนต่างๆ */}
      <style>{`
        .step-card-hover {
        ...
        .step-card-hover:hover {
          ...
          box-shadow: 0 10px 25px rgba(0, 87, 184, 0.08) !important;
        }
      `}</style>
              ...
              >
                ...
                <div
                  style={{
                    ...
                    fontFamily: "var(--font-heading)",
                    fontSize: "1.2rem",
                    boxShadow: "0 4px 10px rgba(0,87,184,0.3)",
                  }}
                >
                  {step.num}
                </div>
