...
function BoardGameBuilding() {
  return (
    <div style={{ position: "relative", width: "100%", height: "100%" }}>
      {/* เรียกใช้งานแอนิเมชันลอยตัวจากสไตล์ CSS ท้องถิ่น */}
      <div
        className="bb-float-1"
        style={{
          position: "absolute",
          top: "0",
          left: "10%",
      ...
      <div
        style={{ position: "absolute", bottom: 0, right: "5%", width: "260px" }}
      >
        <div
          style={{
            background: "#1E3A8A",
...
export default function BoardGameSection() {
  return (
    <section
      id="shop"
      style={{ background: "var(--bb-cream)", paddingBottom: "4rem" }}
    >
      {/* ผูกคลาสสไตล์ความเคลื่อนไหวทั้งหมดไว้ที่นี่เพื่อหลีกเลี่ยงความรวนของบราวเซอร์ */}
      <style>{`
        @keyframes bbFloat1 {
        ...
        .bb-float-1 { animation: bbFloat1 4s ease-in-out infinite; }
        .bb-float-2 { animation: bbFloat2 3.5s ease-in-out infinite; }
      ...
      <div
        style={{
          background: "linear-gradient(160deg,#FFF8E7 0%,#F5EDD0 100%)",
          borderTop: "3px solid rgba(245,200,66,0.3)",
        }}
      >
        <div
          style={{
        ...
        >
          <div>
            ...
            >
              ค้นหาการผจญภัยครั้งใหม่ของคุณและเริ่มต้นเรื่องราวของคุณ
              <br />
              Explore over 1,000+ board games.
            </p>
            <div style={{ display: "flex", gap: "1rem" }}>
              <a href="#all-games" className="btn-primary">
                SHOP NOW
              </a>
      ...
      <div
        style={{
          background: "white",
          padding: "1.1rem 2rem",
          boxShadow: "0 2px 12px rgba(92,58,30,0.08)",
        }}
      >
        <div
          style={{
      ...
      >
            ...
            >
              <div
                style={{
                  ...
                  fontSize: "2.5rem",
                  boxShadow: "0 3px 12px rgba(92,58,30,0.1)",
                  marginBottom: "0.5rem",
                }}
              >
                {cat.icon}
        ...
        <div style={{ position: "relative" }}>
          {/* ปุ่มควบคุมฝั่งซ้าย: สั่งการด้วย Class .bb-swiper-prev */}
          <button
            className="btn-nav-hover bb-swiper-prev"
            aria-label="Prev"
            style={{
              position: "absolute",
              left: "-20px",
              ...
              justifyContent: "center",
              cursor: "pointer",
              boxShadow: "0 3px 10px rgba(92,58,30,0.15)",
              transition: "all 0.2s",
            }}
          >
            <ChevronLeft size={18} />
          ...
          {/* ผูกระบบ Navigation ผ่าน Class มั่นคง ไม่ติดขัดช่วงเรนเดอร์ */}
          <Swiper
            modules={[Navigation]}
            navigation={{
              prevEl: ".bb-swiper-prev",
              nextEl: ".bb-swiper-next",
            }}
            slidesPerView={3}
            spaceBetween={14}
            breakpoints={{
                ...
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow =
                      "0 10px 28px rgba(92,58,30,0.18)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = "none";
                    e.currentTarget.style.boxShadow =
                      "0 3px 12px rgba(92,58,30,0.1)";
                  }}
                >
                  <div
                    style={{
          ...
          {/* ปุ่มควบคุมฝั่งขวา: สั่งการด้วย Class .bb-swiper-next */}
          <button
            className="btn-nav-hover bb-swiper-next"
            aria-label="Next"
            style={{
              position: "absolute",
              right: "-20px",
